...
describe('Block', () => {
    ...
    const block = new Block({ timestamp, lastHash, hash, data }); // if the key an the value are the same name we can declare it just by the name
    ...
    describe('genesis()', ()=> {
        const genesisBlock = Block.genesisBlock(); // static function dont neet to use or change the data on a specific instance of the class
